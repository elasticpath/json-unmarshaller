...
class DefaultJsonUnmarshallerTest {
    ...
    @Test//testing 3 fields, using JsonProperty, absolute and relative JsonPath paths - all fields must be identical
    ...
    @Test//regardless of the annotations, if they all resolve to same path, arrays/iterables should contain same data
